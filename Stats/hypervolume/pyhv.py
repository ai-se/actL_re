...
if __name__ == "__main__":
    # from stats._hypervolume.pyhv import hypervolume
    import numpy
    front = [[0.2, 0.2, 0.2], [0.1, 0.8, 0.2132], [0.3, 0.1, 0.4]]
    ref = numpy.array([1, 1, 1])
    print(hypervolume(front, ref))
